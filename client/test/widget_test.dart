...
//
// AuthService.isLoggedIn only reads local token storage (no network
// call), so an empty in-memory store is enough to test the logged-out
// path deterministically and offline. StreamPassApi is constructed with a
// placeholder base URL since nothing in this test triggers a network
// request.
