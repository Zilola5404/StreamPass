...
cat >/tmp/accelerator_rules.json <<'JSON'
{
  "rules": [
    ...
    {"kind":"CIDR","pattern":"172.217.0.0/16","mode":"RELAY"},
    {"kind":"CIDR","pattern":"216.58.0.0/15","mode":"RELAY"},
    {"kind":"CIDR","pattern":"74.125.0.0/16","mode":"RELAY"},
    {"kind":"CIDR","pattern":"108.177.0.0/16","mode":"RELAY"},
    {"kind":"CIDR","pattern":"142.251.0.0/16","mode":"RELAY"},
    {"kind":"CIDR","pattern":"157.240.0.0/16","mode":"RELAY"},
    {"kind":"CIDR","pattern":"31.13.64.0/18","mode":"RELAY"},
    {"kind":"CIDR","pattern":"185.60.216.0/22","mode":"RELAY"},
    {"kind":"CIDR","pattern":"57.144.0.0/16","mode":"RELAY"},
