...
|----|----------|------------------|-----------|--------|-------------|---------------|
| BL-040 | Live ЮKassa + возврат в app | Ранее BL-004: live/sandbox оплата, poll статуса на E06, deep-link return | P0 | In Progress | — | client: resume poll Done; live keys TODO |
...
| BL-046 | Reconnect при смене сервера | E04→E02: если Connected — Connecting к новому relay | P1 | Done | — | 2026-08-06 |
